...
public class Playerlist extends AbstractCommand {
    ...
    public Playerlist(CoreUserManager userManager, TabManager tabManager, String name, String description) {
    ...
    public void onCommand(SlashCommandInteractionEvent event) {
        ...
        Set<OnlineUser> onlineUsers = userManager.getOnlineUsers();
        ArrayList<String> playerFormat = new ArrayList<>();

        //Set the initial line and default message for an empty server.
        if (onlineUsers.isEmpty()) {
            ...
            for (OnlineUser onlineUser : onlineUsers) {
                ...
                String primaryRole = "[?]";
                Optional<TabPlayer> optionalTabPlayer = tabManager.getTabPlayer(onlineUser.getUuid());
